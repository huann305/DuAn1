...
import com.example.duan1.databinding.FragmentDoingBinding;
...
public class DoingFragment extends BaseFragment<FragmentDoingBinding> {
    ...
    protected void initData() {
        ...
        list = billDAO.getAllWithStatus(BillStatus.DOING);
        adapter = new OrderManagerAdapter(list, getContext()) {
            ...
            public void onItemClick(int position) {
                ...
                intent.putExtra("text_btn", "Hoàn thành");
                onPause();
